...
void ProcessWord(FILE *pTestDataFile, float FontSize, char *buffer);
void GenerateGCode(const char *Word, char *buffer);
...
int main(void)
{
    ...
    ProcessWord(pTestDataFile, FontSize, buffer); // Processes each word in the test data file
